...
!
     ...
     &  "ROMS/Utility/mp_exchange.F"//", mp_exchange2d"
!
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 60, 362, MyFile)
!
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 60, 898,  MyFile)
!
      RETURN
...
!
      character (len=MPI_MAX_ERROR_STRING) :: string
      character (len=*), parameter :: MyFile =                          &
     &  "ROMS/Utility/mp_exchange.F"//", mp_exchange2d_bry"
!
!-----------------------------------------------------------------------
!  Set lower and upper tile bounds and staggered variables bounds for
!  this horizontal domain partition.  Notice that if tile=-1, it will
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 63, 1596,  MyFile)
!
!-----------------------------------------------------------------------
!  Determine rank of tile neighbors and number of ghost-points to
!  exchange.
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 63, 2025, MyFile)
!
      RETURN
...
!
      character (len=MPI_MAX_ERROR_STRING) :: string
      character (len=*), parameter :: MyFile =                          &
     &  "ROMS/Utility/mp_exchange.F"//", mp_exchange3d"
!
!-----------------------------------------------------------------------
!  Set lower and upper tile bounds and staggered variables bounds for
!  this horizontal domain partition.  Notice that if tile=-1, it will
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 61, 2108, MyFile)
!
!-----------------------------------------------------------------------
!  Determine rank of tile neighbors and number of ghost-points to
!  exchange.
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 61, 2743, MyFile)
!
      RETURN
...
!
      character (len=MPI_MAX_ERROR_STRING) :: string
      character (len=*), parameter :: MyFile =                          &
     &  "ROMS/Utility/mp_exchange.F"//", mp_exchange3d_bry"
!
!-----------------------------------------------------------------------
!  Set lower and upper tile bounds and staggered variables bounds for
!  this horizontal domain partition.  Notice that if tile=-1, it will
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 63, 3542, MyFile)
!
!-----------------------------------------------------------------------
!  Determine rank of tile neighbors and number of ghost-points to
!  exchange.
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 63, 4084, MyFile)
!
      RETURN
...
!
      character (len=MPI_MAX_ERROR_STRING) :: string
      character (len=*), parameter :: MyFile =                          &
     &  "ROMS/Utility/mp_exchange.F"//", mp_exchange4d"
!
!-----------------------------------------------------------------------
!  Set lower and upper tile bounds and staggered variables bounds for
!  this horizontal domain partition.  Notice that if tile=-1, it will
...
!-----------------------------------------------------------------------
!
      CALL wclock_on (ng, model, 62, 4170, MyFile)
!
!-----------------------------------------------------------------------
!  Determine rank of tile neighbors and number of ghost-points to
!  exchange.
...
!-----------------------------------------------------------------------
!
      CALL wclock_off (ng, model, 62, 4764, MyFile)
!
      RETURN
