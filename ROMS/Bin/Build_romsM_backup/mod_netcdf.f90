     ...
     &                          TRIM(SourceFile), nf90_strerror(status)
        ...
        ELSE
          IF (n_dim.gt.Mdims) THEN
            ...
            ioerror=0
          END IF
          IF (FoundError(status, nf90_noerr, 465, MyFile)) THEN
...
!
     ...
     &                       ncid = ncid)
      END IF
      IF (FoundError(exit_flag, NoError, 803, MyFile)) RETURN
!
!-----------------------------------------------------------------------
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 1503, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
     ...
     &                            nf90_strerror(status)
        ...
        ELSE
          IF (n_var.gt.Mvars) THEN
            ...
            exit_flag=2
          END IF
          IF (FoundError(status, nf90_noerr, 1613, MyFile)) THEN
...
!
     ...
     &                                      var_Dname(i), var_Dsize(i))
              IF (FoundError(status, nf90_noerr, 1702, MyFile)) THEN
...
!
      IF (InpThread) THEN
        ...
        IF (FoundError(status, nf90_noerr, 1941, MyFile)) THEN
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 2410, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 3513, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          END IF
          IF (FoundError(status, nf90_noerr, 3541, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=2
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 3696, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 3723, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=2
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 3937, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 3964, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=2
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 4184, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 4467, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=2
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 4671, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
     ...
     &                                 xtype = my_type)
          IF (status.eq.nf90_noerr) THEN
            ...
            ELSE IF (my_type.eq.nf90_char) THEN
              ...
              END IF
            END IF
            IF (FoundError(status, nf90_noerr, 4711, MyFile)) THEN
              WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),          &
     &                          TRIM(SourceFile), nf90_strerror(status)
              exit_flag=2
              ioerror=status
     ...
     &                                 xtype = my_type)
          IF (status.eq.nf90_noerr) THEN
            ...
            ELSE IF (my_type.eq.nf90_char) THEN
              ...
              END IF
            END IF
            IF (FoundError(status, nf90_noerr, 4878, MyFile)) THEN
              WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),          &
     &                          TRIM(SourceFile), nf90_strerror(status)
              exit_flag=2
              ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 4997, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 5013, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=2
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 5122, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 5137, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=2
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 5247, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 5262, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=2
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 5382, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 5398, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=2
            ioerror=status
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 5527, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=2
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 5641, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 5656, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=2
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 5770, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 5785, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=2
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 5928, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 5944, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=2
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 6238, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 6253, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=2
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        ...
        IF (FoundError(exit_flag, NoError, 7022, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          ...
          IF (FoundError(status, nf90_noerr, 7032, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          END IF
          IF (FoundError(status, nf90_noerr, 7051, MyFile)) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 7151, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 7161, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          IF (FoundError(status, nf90_noerr, 7175, MyFile)) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 7275, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 7285, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 7299, MyFile)) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 7399, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 7409, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 7423, MyFile)) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 7523, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 7533, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 7547, MyFile)) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 7649, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 7659, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          ELSE
            ...
            status=nf90_put_var(my_ncid, my_varid, my_A, start, total)
          END IF
          IF (FoundError(status, nf90_noerr, 7678, MyFile)) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 7778, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 7788, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 7802, MyFile)) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 7902, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 7912, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 7926, MyFile)) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 8032, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 8042, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          END IF
          IF (FoundError(status, nf90_noerr, 8070, MyFile)) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 8175, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 8185, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          IF (FoundError(status, nf90_noerr, 8210, MyFile)) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 8315, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 8325, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, AI, start, total)
          IF (FoundError(status, nf90_noerr, 8352, MyFile)) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 8462, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 8472, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          ELSE
            ...
            status=nf90_put_var(my_ncid, my_varid, my_A, start, total)
          END IF
          IF (FoundError(status, nf90_noerr, 8491, MyFile)) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 8601, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 8611, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 8625, MyFile)) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 8735, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 8745, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 8759, MyFile)) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 8869, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 8879, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 8893, MyFile)) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          IF (FoundError(status, nf90_noerr, 9049, MyFile)) THEN
...
!
      ...
      IF (OutThread) THEN
        ...
        IF (FoundError(status, nf90_noerr, 9171, MyFile)) THEN
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          IF (FoundError(status, nf90_noerr, 9188, MyFile)) THEN
...
!
      IF (OutThread) THEN
        ...
        IF (FoundError(status, nf90_noerr, 9269, MyFile)) THEN
      ...
      IF (InpThread) THEN
        SELECT CASE (omode)
          ...
          CASE DEFAULT
            ...
            status=nf90_open(TRIM(ncname), my_omode, ncid)
        END SELECT
        IF (FoundError(status, nf90_noerr, 9402, MyFile)) THEN
          WRITE (stdout,10) TRIM(ncname), TRIM(SourceFile),             &
     &                      nf90_strerror(status)
          exit_flag=3
          ioerror=status
...
!
      IF (OutThread) THEN
        ...
        IF (FoundError(status, nf90_noerr, 9482, MyFile)) THEN
          IF (Master) WRITE (stdout,10) TRIM(ncname), TRIM(SourceFile), &
     &                                  nf90_strerror(status)
          exit_flag=3
          ioerror=status
...
!
      IF (OutThread) THEN
        ...
        IF (FoundError(status, nf90_noerr, 9550, MyFile)) THEN
          WRITE (stdout,10) TRIM(ncname), TRIM(SourceFile),             &
     &                      nf90_strerror(status)
          exit_flag=3
          ioerror=status
