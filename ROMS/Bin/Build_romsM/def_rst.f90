...
!
      DEFINE : IF (Ldefine) THEN
        ...
        IF (FoundError(exit_flag, NoError, 181, MyFile)) THEN
...
!
     ...
     &                 NF_FRST, nvd3, t2dgrd, Aval, Vinfo, ncname)
        IF (FoundError(exit_flag, NoError, 825, MyFile)) RETURN
!
...
!
     ...
     &                 NF_FRST, nvd3, v2dgrd, Aval, Vinfo, ncname)
        IF (FoundError(exit_flag, NoError, 929, MyFile)) RETURN
!
...
!
     ...
     &                 NF_FRST, nvd4, v3dgrd, Aval, Vinfo, ncname)
        IF (FoundError(exit_flag, NoError, 1037, MyFile)) RETURN
!
...
!
     ...
     &                   NF_FRST, nvd4, t3dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 1100, MyFile)) RETURN
        END DO
!
...
!
     ...
     &                   nvd3, sr2dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 1505, MyFile)) RETURN
        END DO
!
!-----------------------------------------------------------------------
...
!
        ...
        IF (FoundError(exit_flag, NoError, 1629, MyFile)) RETURN
!
!-----------------------------------------------------------------------
...
!
        ...
        IF (FoundError(exit_flag, NoError, 1636, MyFile)) RETURN
      END IF DEFINE
!
!=======================================================================
...
!
        ...
        IF (FoundError(exit_flag, NoError, 1651, MyFile)) THEN
...
!
     ...
     &                         ncid = RST(ng)%ncid)
        IF (FoundError(exit_flag, NoError, 1660, MyFile)) RETURN
!
