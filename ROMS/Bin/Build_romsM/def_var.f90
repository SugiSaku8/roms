...
!
     ...
     &                            Vdim(1:nVdim), Vid)
            END IF
            IF (FoundError(status, nf90_noerr, 165, MyFile)) THEN
...
!
     ...
     &                          'grid_topology')
            IF (FoundError(status, nf90_noerr, 204, MyFile)) THEN
...
!
     ...
     &                          (/2/))
            IF (FoundError(status, nf90_noerr, 214, MyFile)) THEN
...
!
     ...
     &                          'xi_psi eta_psi')
            IF (FoundError(status, nf90_noerr, 224, MyFile)) THEN
...
!
     ...
     &                          TRIM(text))
            IF (FoundError(status, nf90_noerr, 236, MyFile)) THEN
...
!
     ...
     &                          TRIM(text))
            IF (FoundError(status, nf90_noerr, 247, MyFile)) THEN
...
!
     ...
     &                          TRIM(text))
            IF (FoundError(status, nf90_noerr, 258, MyFile)) THEN
...
!
     ...
     &                            'lon_psi lat_psi')
              IF (FoundError(status, nf90_noerr, 269, MyFile)) THEN
...
!
     ...
     &                            'lon_rho lat_rho')
              IF (FoundError(status, nf90_noerr, 279, MyFile)) THEN
...
!
     ...
     &                                        TRIM(ncname)
            ...
            ELSE
              status=nf90_put_att(ncid, Vid, 'node_coordinates',        &
     &                            'x_psi y_psi')
              IF (FoundError(status, nf90_noerr, 309, MyFile)) THEN
                IF (Master) WRITE (stdout,30) 'node_coordinates',       &
     &                                        TRIM(Vinfo(1)),           &
     &                                        TRIM(ncname)
                exit_flag=3
...
!
              status=nf90_put_att(ncid, Vid, 'edge1_coordinates',       &
     &                            'x_u y_u')
              IF (FoundError(status, nf90_noerr, 329, MyFile)) THEN
                IF (Master) WRITE (stdout,30) 'edge1_coordinates',      &
     &                                        TRIM(Vinfo(1)),           &
     &                                        TRIM(ncname)
                exit_flag=3
...
!
              status=nf90_put_att(ncid, Vid, 'edge2_coordinates',       &
     &                            'x_v y_v')
              IF (FoundError(status, nf90_noerr, 339, MyFile)) THEN
                IF (Master) WRITE (stdout,30) 'edge2_coordinates',      &
     &                                        TRIM(Vinfo(1)),           &
     &                                        TRIM(ncname)
                exit_flag=3
...
!
     ...
     &                          's_rho: s_w (padding: none)')
            IF (FoundError(status, nf90_noerr, 351, MyFile)) THEN
...
!
     ...
     &                          Vinfo(21)(1:latt))
            IF (FoundError(status, nf90_noerr, 369, MyFile)) THEN
...
!
     ...
     &                          Vinfo(2)(1:latt))
            IF (FoundError(status, nf90_noerr, 387, MyFile)) THEN
...
!
     ...
     &                          Vinfo(19)(1:latt))
            IF (FoundError(status, nf90_noerr, 404, MyFile)) THEN
...
!
     ...
     &                            Vinfo(3)(1:latt))
              IF (FoundError(status, nf90_noerr, 422, MyFile)) THEN
...
!
     ...
     &                            Aval(2))
            END IF
            IF (FoundError(status, nf90_noerr, 467, MyFile)) THEN
...
!
     ...
     &                            Aval(3))
            END IF
            IF (FoundError(status, nf90_noerr, 495, MyFile)) THEN
...
!
     ...
     &                            text(1:latt))
              IF (FoundError(status, nf90_noerr, 521, MyFile)) THEN
...
!
     ...
     &                          Vinfo(11)(1:latt))
            IF (FoundError(status, nf90_noerr, 585, MyFile)) THEN
...
!
     ...
     &                          Vinfo(12)(1:latt))
            IF (FoundError(status, nf90_noerr, 602, MyFile)) THEN
...
!
     ...
     &                          Vinfo(25)(1:latt))
            IF (FoundError(status, nf90_noerr, 619, MyFile)) THEN
...
!
     ...
     &                          Vinfo(16)(1:latt))
            IF (FoundError(status, nf90_noerr, 670, MyFile)) THEN
...
!
     ...
     &                          text(1:latt))
            IF (FoundError(status, nf90_noerr, 694, MyFile)) THEN
...
!
     ...
     &                            Aval(4))
            END IF
            IF (FoundError(status, nf90_noerr, 721, MyFile)) THEN
...
!
     ...
     &                            Aval(6))
            END IF
            IF (FoundError(status, nf90_noerr, 777, MyFile)) THEN
          ...
          IF (latt.gt.0) THEN
            ...
            IF (spherical) THEN
              ...
              ELSE IF (INT(Aval(5)).eq.w3dvar) THEN
                ...
                location='face'
              ELSE IF (INT(Aval(5)).eq.a3dvar) THEN
                text='lon_rho lat_rho Nveg'
                location='face'
