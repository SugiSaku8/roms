...
!
      ...
      UBij=BOUNDS(ng)%UBij
!
      CALL wclock_on (ng, model, 2, 84, MyFile)
     ...
     &                      OCEAN(ng) % vbar,                           &
     &                      OCEAN(ng) % zeta)
      CALL wclock_off (ng, model, 2, 130, MyFile)
!
      RETURN
...
!
      character (len=*), parameter :: MyFile =                          &
     &  "ROMS/Nonlinear/ini_fields.F"//", ini_zeta"
!
      integer :: IminS, ImaxS, JminS, JmaxS
      integer :: LBi, UBi, LBj, UBj, LBij, UBij
!
...
!
      ...
      UBij=BOUNDS(ng)%UBij
!
      CALL wclock_on (ng, model, 2, 735, MyFile)
     ...
     &                    GRID(ng) % rmask,                             &
     &                    OCEAN(ng) % zeta)
      CALL wclock_off (ng, model, 2, 757, MyFile)
!
      RETURN
...
!-----------------------------------------------------------------------
!
      CALL set_zeta_timeavg (ng, tile, model)
!
      RETURN
!
...
!
!***********************************************************************
      SUBROUTINE set_zeta_timeavg (ng, tile, model)
!***********************************************************************
!
      USE mod_stepping
!
...
!
      character (len=*), parameter :: MyFile =                          &
     &  "ROMS/Nonlinear/ini_fields.F"//", set_zeta_timeavg"
!
      integer :: IminS, ImaxS, JminS, JmaxS
      integer :: LBi, UBi, LBj, UBj, LBij, UBij
!
...
!
      ...
      UBij=BOUNDS(ng)%UBij
!
      CALL wclock_on (ng, model, 2, 1013, MyFile)
      CALL set_zeta_timeavg_tile (ng, tile, model,                      &
     &                            LBi, UBi, LBj, UBj,                   &
     &                            kstp(ng),                             &
     &                            OCEAN(ng) % zeta,                     &
     &                            COUPLING(ng) % Zt_avg1)
      CALL wclock_off (ng, model, 2, 1021, MyFile)
!
      RETURN
      END SUBROUTINE set_zeta_timeavg
!
!***********************************************************************
      SUBROUTINE set_zeta_timeavg_tile (ng, tile, model,                &
     &                                  LBi, UBi, LBj, UBj,             &
     &                                  kstp,                           &
     &                                  zeta,                           &
     &                                  Zt_avg1)
...
!
      RETURN
      END SUBROUTINE set_zeta_timeavg_tile
