...
!
      ...
      UBij=BOUNDS(ng)%UBij
!
      CALL wclock_on (ng, iNLM, 30, 67, MyFile)
      CALL uv3dmix2_s_tile (ng, tile,                                   &
     &                      LBi, UBi, LBj, UBj,                         &
     ...
     &                      OCEAN(ng) % u,                              &
     &                      OCEAN(ng) % v)
      CALL wclock_off (ng, iNLM, 30, 107, MyFile)
!
      RETURN
      END SUBROUTINE uv3dmix2
!
!***********************************************************************
      SUBROUTINE uv3dmix2_s_tile (ng, tile,                             &
     &                            LBi, UBi, LBj, UBj,                   &
     &                            IminS, ImaxS, JminS, JmaxS,           &
     &                            nrhs, nnew,                           &
     &                            pmask,                                &
...
!
      RETURN
      END SUBROUTINE uv3dmix2_s_tile
