...
!
!  Force-enable a subset of diagnostics to guarantee definition
!  of tracer and UV diagnostic variables when creating the file.
!
!
!-----------------------------------------------------------------------
...
!
        ...
        IF (FoundError(exit_flag, NoError, 471, MyFile)) RETURN
!
!-----------------------------------------------------------------------
...
!
        ...
        IF (FoundError(exit_flag, NoError, 721, MyFile)) RETURN
!
!-----------------------------------------------------------------------
...
!
        ...
        IF (FoundError(exit_flag, NoError, 742, MyFile)) THEN
...
!
     ...
     &                         ncid = DIA(ng)%ncid)
        IF (FoundError(exit_flag, NoError, 751, MyFile)) RETURN
!
