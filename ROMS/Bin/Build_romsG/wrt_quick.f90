...
!
     ...
     &                     GRID(ng) % z_v,                              &
     &                     SetFillVal = .FALSE.)
        IF (FoundError(status, nf90_noerr, 401, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % z_w,                              &
     &                     SetFillVal = .FALSE.)
        IF (FoundError(status, nf90_noerr, 425, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     OCEAN(ng) % ubar(:,:,kstp(ng)))
        IF (FoundError(status, nf90_noerr, 477, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     OCEAN(ng) % vbar(:,:,kstp(ng)))
        IF (FoundError(status, nf90_noerr, 500, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % rmask_full,                       &
     &                     Ur2d)
        IF (FoundError(status, nf90_noerr, 543, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     OCEAN(ng) % u(:,:,N(ng),nrhs(ng)))
        IF (FoundError(status, nf90_noerr, 587, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % rmask_full,                       &
     &                     OCEAN(ng) % va)
        IF (FoundError(status, nf90_noerr, 750, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % rmask_full,                       &
     &                     OCEAN(ng) % ua(:,:,N(ng)))
        IF (FoundError(status, nf90_noerr, 773, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % rmask_full,                       &
     &                     OCEAN(ng) % va(:,:,N(ng)))
        IF (FoundError(status, nf90_noerr, 796, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                       OCEAN(ng) % t(:,:,:,nrhs(ng),itrc))
          IF (FoundError(status, nf90_noerr, 1085, MyFile)) THEN
            IF (Master) THEN
...
!
     ...
     &                       GRID(ng) % rmask,                          &
     &                       Wr3d)
          IF (FoundError(status, nf90_noerr, 1150, MyFile)) THEN
            IF (Master) THEN
...
!
     ...
     &                     MIXING(ng) % Akt(:,:,:,itemp),               &
     &                     SetFillVal = .FALSE.)
        IF (FoundError(status, nf90_noerr, 1274, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     MIXING(ng) % Akt(:,:,:,isalt),               &
     &                     SetFillVal = .FALSE.)
        IF (FoundError(status, nf90_noerr, 1299, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     SetFillVal = .FALSE.)
        IF (FoundError(status, nf90_noerr, 1325, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     SetFillVal = .FALSE.)
        IF (FoundError(status, nf90_noerr, 1350, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                       FORCES(ng) % stflx(:,:,itrc))
          IF (FoundError(status, nf90_noerr, 1567, MyFile)) THEN
            IF (Master) THEN
...
!
     ...
     &                     FORCES(ng) % stflux(:,:,isalt))
        IF (FoundError(status, nf90_noerr, 1715, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % umask,                            &
     &                     FORCES(ng) % sustr)
        IF (FoundError(status, nf90_noerr, 1764, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % umask,                            &
     &                     FORCES(ng) % bustr)
        IF (FoundError(status, nf90_noerr, 1810, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % vmask,                            &
     &                     FORCES(ng) % bvstr)
        IF (FoundError(status, nf90_noerr, 1833, MyFile)) THEN
          IF (Master) THEN
